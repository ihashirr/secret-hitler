...
export default function RoleReveal({ gameState, playerId, onReady, onReset }) {
  ...
  console.log("[RoleReveal] Render:", { playerId, meFound: !!me, isReady: me?.isReady, phase: gameState.phase });
  ...
  console.log("[RoleReveal] Waiting for:", gameState.players.filter(p => !p.isReady).map(p => p.name));
